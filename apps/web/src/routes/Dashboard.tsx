...
const defaultDraft: SiteDraftInput = {
  ...
  branding: {
    ...
    lightBackgroundColor: "#fbf1e6",
    darkBackgroundColor: "#0f0b09",
    lightSurfaceColor: "#fffaf4",
    darkSurfaceColor: "#1d1612",
    lightSurfaceMutedColor: "#f3e4d3",
    darkSurfaceMutedColor: "#2a2019",
    lightSurfaceAccentColor: "#ead2b8",
    darkSurfaceAccentColor: "#37281f",
    lightBorderColor: "#e0cab1",
    darkBorderColor: "rgba(233,204,168,0.11)",
    lightBorderStrongColor: "#bd9368",
    darkBorderStrongColor: "rgba(233,204,168,0.2)",
    lightBorderAccentColor: "#c89b6d",
    darkBorderAccentColor: "rgba(185,130,85,0.38)",
    lightSurfaceDangerColor: "#fff1f1",
    darkSurfaceDangerColor: "#3a2020",
    lightBorderDangerColor: "#f1c5c5",
    darkBorderDangerColor: "#6f3535",
    lightTextColor: "#3a271b",
    darkTextColor: "#ead7c1",
    lightHeadingColor: "#24170f",
    darkHeadingColor: "#f7eadc",
    lightMutedColor: "#8a654b",
    darkMutedColor: "#c3a382",
    lightNavColor: "#6f4c35",
    darkNavColor: "#c3a382",
    lightAccentColor: "#8c5d36",
    darkAccentColor: "#b98255",
    lightAccentStrongColor: "#5f3a21",
    darkAccentStrongColor: "#e0b07f",
    lightAccentTextColor: "#fff8ee",
    darkAccentTextColor: "#23170f",
    lightButtonPrimaryColor: "#8c5d36",
    darkButtonPrimaryColor: "#b98255",
    lightButtonPrimaryTextColor: "#fff8ee",
    darkButtonPrimaryTextColor: "#23170f",
    lightButtonSecondaryColor: "#ead2b8",
    darkButtonSecondaryColor: "#2a2019",
    lightButtonSecondaryTextColor: "#5f3a21",
    darkButtonSecondaryTextColor: "#e0b07f",
    lightButtonSecondaryBorderColor: "#c89b6d",
    darkButtonSecondaryBorderColor: "rgba(233,204,168,0.16)",
    lightDangerColor: "#b42318",
    darkDangerColor: "#ff9b8f",
    lightNavActiveColor: "#ead2b8",
    darkNavActiveColor: "#2a2019",
    lightTopbarColor: "rgba(251,241,230,0.92)",
    darkTopbarColor: "#0f0b09",
    surfaceColor: "#1d1612",
    textColor: "#ead7c1",
    headingColor: "#f7eadc",
    accentColor: "#b98255"
